define(function(require, exports, module) {
  ...
  /**
   *  Slide the items behind one another.
   *  @class SingularSlideBehind
   *  @param {Options} [options] An object of configurable options.
   *  @param {Number} [options.rotationAngle] Rotation angle to be applied in Radians.
   */
  module.exports = function SingularSlideBehind (options) {
    return {
      options: options,
      defaultOptions: { 
        duration: 750,
