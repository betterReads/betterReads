define(function(require, exports, module) {
  ...
  /**
   * SingularParallax the current and last item against one another.
   * 
   ...
   */
  module.exports = function SingularParallax (options) {
    return {
      options: options,
      ...
      layout: function (options) {
        ...
        function last (item, containerSize, index, lastIndex) {
          ...
          item.opacity.set(0, {
            curve: 'linear', 
            duration: options.curve.period || options.curve.duration
          });
