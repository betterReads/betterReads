define(function(require, exports, module){
  ...
  BookshelfCarousel.prototype.focus = function(payload){
    ...
    this.info.setContent('<div  style="border-top: 1px solid #F28A75; color: #808080;"><span style="font-size: 22px; font-weight: bold; color: #F28A75;">' + infoTitle + '</span><br>' + infoAuthor + '<br>' + infoRating + '</div>');
