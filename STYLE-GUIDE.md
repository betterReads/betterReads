...
* In general, don't use function statements to write functions and methods. Instead, declare them as variables. This helps keep memory clean, in addition to avoiding odd behaviors that can arise from hoisting.
...
Any and all other view methods should be created as properties of that view's prototype.
    ...
    function _createSurface(){
      // this function builds a surface and adds it to the view
      // it's a constructor helper function, thus it is safe to hoist and only needs to be accessed inside the view
    }
    
    myView.prototype.bounce = function(){
      // this function plays an animation on a surface
    ...
    myView.prototype._createSurface = function(){
      // this function builds a surface and adds it to the view
      // as a prototype method, this is dangerously accessible to other views, and can break your UI
    }
    
    function bounce(){
      // this function plays an animation on a surface
      // we can't use this anywhere else
    }
    ```
